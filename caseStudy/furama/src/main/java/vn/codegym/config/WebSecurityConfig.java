...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/employee/save","/employee/update","/employee/create","/employee/{id}/update","/employee/{id}/delete/").hasAnyRole("QUANLY", "GIAMDOC")
                .antMatchers("/customer/list","/customer/save","/customer/update","/customer/create","/customer/{id}/update","/customer/{id}/delete/").hasAnyRole("QUANLY", "GIAMDOC")
